//
//  AGVisitorMainPageViewController.swift
//  ArtGallery
//
//  Created by Weibo Wang on 2016-11-06.
...
class AGVisitorMainPageViewController: UIViewController {
    ...
    var searchStatus: Bool = false{
        didSet{
            if searchStatus == true && searchStatus != oldValue{
            }
            else{
...
//        self.view.addSubview(self.scrollView)
        ...
        // view 1
        followView = AGArtistMPFollowView.init(frame: CGRect.init(x: 0, y: 0, width: GlobalValue.SCREENBOUND.width, height: scroll_height), id: 1)
        // visitor 页面 最先显示的是 follow view
        followView.firstTimeInit()
...
extension AGVisitorMainPageViewController: SlideNavigationControllerDelegate{
