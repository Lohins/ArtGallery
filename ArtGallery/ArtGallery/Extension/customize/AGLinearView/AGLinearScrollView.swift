...
class AGLinearScrollView: TPKeyboardAvoidingScrollView {
    
    // variables
    
    var items: [AGLinearScrollViewItem] = [AGLinearScrollViewItem]()
...
//    }
    ...
    func linear_addSubview(_ view: UIView , paddingTop:CGFloat, paddingBottom: CGFloat){
        ...
        let item = AGLinearScrollViewItem.init(view: view, paddingTop: paddingTop, paddingBottom: paddingBottom)
    ...
    func linear_removeView(_ view: UIView){
        var target: AGLinearScrollViewItem?
    ...
    func liear_replaceWithItems(_ items: [AGLinearScrollViewItem]){
    ...
    func linear_insertView(before previousView: UIView, for targetView: UIView,paddingTop: CGFloat, paddingBottom: CGFloat){
        var previousItem: AGLinearScrollViewItem?
        for item in self.items{
        ...
        if let item  = previousItem{
            ...
            let newItem = AGLinearScrollViewItem.init(view: targetView, paddingTop: paddingTop, paddingBottom: paddingBottom)
